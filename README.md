...
<p align="center">
  <a href="https://devtools.at/tools/emoji-picker"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Browse and copy emojis</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/emoji-picker">Try Online</a> •
...
**[Try Emoji Picker online at DevTools.at →](https://devtools.at/tools/emoji-picker)**
...
Browse and copy emojis. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/emoji-picker';
